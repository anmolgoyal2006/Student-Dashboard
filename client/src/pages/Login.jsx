...
export default function Login() {
  ...
  const fields = [
    ...
    { label: 'Password', name: 'password', type: 'password', placeholder: 'Enter your password', icon: Icons.lock },
  ];
    ...
    <div className="login-page">
      ...
      <div className="login-wrapper">
        ...
        <div className="login-brand">
          ...
          <p className="brand-tagline">Smart academics. Better career. All in one powerful platform.</p>
        ...
        <div className="login-form-panel">
          ...
          <form onSubmit={handleSubmit} className="login-form">
            ...
            <div style={{ display: 'flex', alignItems: 'center', gap: 12, margin: '8px 0' }}>
              ...
              <span style={{ fontSize: 12, color: '#52525b', fontWeight: 500 }}>or continue with</span>
              <div style={{ flex: 1, height: 1, background: 'rgba(255,255,255,0.06)' }} />
            </div>
          ...
          <p style={{ textAlign: 'center', marginTop: 24, fontSize: 12, color: '#52525b' }}>
            Made with care by <span style={{ color: '#a78bfa', fontWeight: 600 }}>Anmol Goyal</span>
          </p>
        </div>
      </div>
    </div>
