...
const s = {
  ...
  title: { fontSize: 18, fontWeight: 700, margin: '0 0 6px', color: 'var(--text, var(--color-text-primary))' },
  sub:   { fontSize: 14, color: 'var(--muted, var(--color-text-secondary))', margin: '0 0 24px' },
  ...
  btnPresent: { background: 'rgba(34,197,94,0.2)',  color: 'var(--color-success)' },
  btnAbsent:  { background: 'rgba(239,68,68,0.2)',  color: 'var(--color-danger)' },
  btnNeutral: { background: 'rgba(99,102,241,0.2)', color: 'var(--color-accent)' },
  dismiss: {
    background: 'transparent', border: 'none',
    color: 'var(--muted, var(--color-text-secondary))', cursor: 'pointer',
